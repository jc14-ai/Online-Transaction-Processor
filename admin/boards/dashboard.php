    ...
    <div class="overview-board">
      ...
      <div class="order-analytics">
        ...
        <div class="orders-pending-display">
          ...
          <h4 class="num-of-orders-pending-label"><?php
